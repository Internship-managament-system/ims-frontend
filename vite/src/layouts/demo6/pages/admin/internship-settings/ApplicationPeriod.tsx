...
const ApplicationPeriod: React.FC = () => {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      setApplicationPeriod(tempValue);
      setIsEditing(false);
      setIsSaving(false);
    }, 800);
  };
    ...
    <Container>
      <div className="p-5">
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <h2 className="text-xl font-semibold mb-6">Staj Başvuru Süresi Ayarı</h2>
          
          <div className="mb-6">
            <p className="text-gray-600 mb-4">
              Öğrenciler staj başlangıç tarihinden kaç gün önce başvuru yapabilecek? Bu değer staj başvuru formundaki 
              başlangıç tarihi seçimi için minimum süreyi belirler.
            </p>
              ...
              <div className="flex items-end gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    onClick={() => {
                      setTempValue(applicationPeriod);
                      setIsEditing(false);
                    }}
                    disabled={isSaving}
                  >
